...
# Modelo de dados para o Balconista Inteligente
...
def sitemap(db: Session = Depends(get_db)):
    ...
    urlset = []
    urlset.append(
        '<url><loc>https://linkpecas.online/</loc><changefreq>daily</changefreq><priority>1.0</priority></url>'
    )
    urlset.append(
        '<url><loc>https://linkpecas.online/ofertas</loc><changefreq>daily</changefreq><priority>0.9</priority></url>'
    )
    urlset.append(
        '<url><loc>https://linkpecas.online/lojas</loc><changefreq>weekly</changefreq><priority>0.8</priority></url>'
    )
    ...
    for ad in ads:
        ...
        urlset.append(
            f"<url><loc>{loc}</loc><lastmod>{lastmod_str}</lastmod><changefreq>weekly</changefreq><priority>0.8</priority></url>"
        )
